...
struct SFSymbolMod: View {
    var moduleInfo: [InfoCard] = [
        ...
        InfoCard(title: "Digestible Bite", description: "Using SF Symbols ensures your SF Symbols match Apple’s visual language and support accessibility features."),
        InfoCard(title: "Pro Tip:", description: "Use system-provided SF Symbols where possible—especially for common actions like delete, share, and edit."),
        InfoCard(title: "Try This:", description: "Replace any PNG SF Symbols in your design with an equivalent SF Symbol and check for visual consistency."),
